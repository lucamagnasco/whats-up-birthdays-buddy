...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'index.whatsappPlaceholder': 'Phone number',
    'index.whatsappHelp': 'Required for birthday reminders! Select your country and enter your phone number',
    'index.whatsappExample': 'Example: 1188899999 (Argentina), 7123456789 (UK)',
    'index.countryCode': 'Country Code',
    'index.selectCountry': 'Select your country',
  ...
  es: {
    ...
    'index.whatsappPlaceholder': 'Número de teléfono',
    'index.whatsappHelp': '¡Requerido para recordatorios de cumpleaños! Selecciona tu país e ingresa tu número de teléfono',
    'index.whatsappExample': 'Ejemplo: 1188899999 (Argentina), 7123456789 (Reino Unido)',
    'index.countryCode': 'Código de País',
    'index.selectCountry': 'Selecciona tu país',
